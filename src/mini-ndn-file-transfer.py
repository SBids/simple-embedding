...
rl_dir = "/home/bidhya/Desktop/simple-embedding"
...
if __name__ == '__main__':
    ...
    testFile = "/home/bidhya/Desktop/simple-embedding/files/{}.dat".format(_F_NAME)
    ...
    # rl_path = os.path.join(rl_dir, "base_with_replay.py")
